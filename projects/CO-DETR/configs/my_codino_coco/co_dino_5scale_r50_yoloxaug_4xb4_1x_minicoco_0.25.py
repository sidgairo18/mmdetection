...
model = dict(
    ...
    use_lsj=True, # disable lsj since using yolox augs
    # detr: 52.1
    # one-stage: 49.4
    # two-stage: 47.9
...
train_pipeline = [
    ...
    dict(type='FilterAnnotations', min_gt_bbox_wh=(1, 1), keep_empty=False), # can update to dict(type='FilterAnnotations', min_gt_bbox_wh=(1e-2, 1e-2))
    dict(type='PackDetInputs')
]

# Use MultiImageMixDataset wrapper like YOLOX
