...
# imports for LoadImageFromFile from mmcv
import mmengine.fileio as fileio                                                          
from .instance_augment import Augmenter as inst_augmenter
                                                                                          
                                                                                          
@TRANSFORMS.register_module()                                                             
class LoadImageFromFileInstAug(LoadImageFromFile):                                                   
    ...
    def __init__(self,                                                                    
                 inst_augment_base_dir: Optional[str]=None,
                 inst_augment_p: Optional[float]=None,
                 **kwargs) -> None:                            
        super().__init__(**kwargs)
        self.inst_augmenter = inst_augmenter(inst_augment_base_dir, p=inst_augment_p, rgb=False)
    ...
    def transform(self, results: dict) -> Optional[dict]:                                 
        ...
        # instance augmentation happening here
        img = self.inst_augmenter.augment_image(img, filename.split('/')[-1])
